...
\section{LingBot-VA and RoboTwin Integration Details}
\label{app:lingbot-integration}

\subsection{Audited Implementation Boundary}

The implementation described here was audited at FBFM commit
\texttt{3ecac79} against the released LingBot-VA commit \texttt{7c6ffa9}. The
integration retains the
...
in Appendix~\ref{app:pseudoinverse}, without decoding and re-encoding the
predicted endpoint at each solver evaluation.

\subsection{Deterministic Pseudo-Asynchronous Schedule}
