...
$(\mathcal H_t,\mathbf X_t)\sim\mathcal D$,
$\boldsymbol\epsilon\sim\mathcal N(\mathbf 0,\mathbf I)$, and
$\tau\sim p(\tau)$. Uniform sampling is the standard choice, while non-uniform
schedules may emphasize particular noise levels.
