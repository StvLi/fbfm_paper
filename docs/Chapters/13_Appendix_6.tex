...
preserves the scene structure over the evaluated horizon. Figure~\ref{fig:wan-slot-ablation-mae}
summarizes this image-space diagnostic.
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{../material/wan2.2/slot_ablation_mae_curve.png}
    \caption{Image-space error under finite feedback coverage. Curves report
    frame-wise table-region MAE; vertical lines mark the ends of the measured
    prefixes for the 10- and 20-slot settings.}
