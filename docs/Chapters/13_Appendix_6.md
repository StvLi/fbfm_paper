...
![Image-space error under finite feedback coverage. Curves report the
frame-wise table-region MAE, and vertical lines mark the ends of the measured
prefixes for the 10- and 20-slot settings.](../../material/wan2.2/slot_ablation_mae_curve.png)
