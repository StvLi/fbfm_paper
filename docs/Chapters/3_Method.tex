...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.49\textwidth]{../material/mask/parallel_0_cropped.png}
    \hfill
    \includegraphics[width=0.46\textwidth]{../material/mask/parallel_1_cropped.png}
    \caption{Masked FBFM guidance for a joint-generation WAM: \emph{left,} the
    ...
    both modalities; \emph{right,} each newly encoded observation activates its
