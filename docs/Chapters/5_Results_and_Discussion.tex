...
visual prediction. The unscaled state-only setting used here ($k_p=1$) still
produces visible high-frequency artifacts;
Appendix~\ref{app:wan-video-codec-diagnostic} analyzes the related video-codec
behavior.
