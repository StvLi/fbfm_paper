...
all four evaluated suites. Appendix~\ref{app:detailed-results} reports every
suite and task.
...
\begin{table}[H]
    ...
    \begin{tabular}{lccc}
        \toprule
        Method & LIBERO-Goal & LIBERO-10 & Total \\
        \midrule
        DreamZero (Base, NONE) & 68.5 & 60.5 & 70.125 \\
        DreamZero + FBFM (Ours) & \textbf{71.0} & \textbf{63.0} & \textbf{70.750} \\
        \bottomrule
    \end{tabular}
    \caption{DreamZero success rates (\%). Total pools all four evaluated suites.}
