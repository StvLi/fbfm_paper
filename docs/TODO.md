...
- [ ] Complete Appendix D with matched final records for all selected 42 RoboTwin tasks under both clean and randomized configurations for LingBot-VA Base/FBFM; keep longer excluded tasks outside the main tables.
