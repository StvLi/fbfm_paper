...
- [ ] Freeze and report the exact revisions used for the final tables, together with upstream model versions, checkpoint artifact identifiers, dependency environments, accelerator hardware, and random seeds. DreamZero's published canonical causal-rolling implementation is branch `fix/dreamzero-rolling-feedback` at `5300093a85f412c10479a25f7179b8482130b83d`; the exact A6000 deployment is branch `runnable-dreamzero-fbfm-libero` at `a7dcd4a4bbf69709c038fb433bbc1cf42b029f63` and is the reference for the LIBERO results. Do not reproduce this track from the default `main` branch. The current LingBot-VA/RoboTwin worktree is based on `e482dccb6841f3a2bea73128e05b0954371ee9be`, but its run-specific changes remain uncommitted and require a final frozen revision. Retain `3604b457a24485cddf326a997e48955b7ca6b548` only as the earlier theory-audit point.
